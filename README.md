...
If SoT won't open quickly enough when you click ready button I'd recommend starting run command on windows (win + r) and write in "steam://flushconfig". After that restart your pc and it should be fine.
